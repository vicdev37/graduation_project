...
function form() {
  ...
  var form = document.getElementsByClassName('form, form-control')[0],
...
function modal() {
  ...
  Array.from(close).forEach(function (el) {
    el.addEventListener('click', function () {
      Array.from(popupsAll).forEach(function (popup) {
        closePopup(popup);
      });
    });
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function tabs() {// const tab = document.querySelectorAll('.info-header-tab'),
